...
{return formatTime(o.aData.totalresult,o.aData.totalstatus)+" ("+o.aData.totalplace+")";}}});col++;columns.push({"sTitle":"TotalStatus","bVisible":false,"aTargets":[col++],"sType":"numeric","mDataProp":"totalstatus"});columns.push({"sTitle":Resources["_TOTAL"]+"+","sClass":"center","bSortable":false,"aTargets":[col++],"mDataProp":"totalplus","fnRender":function(o,val)
